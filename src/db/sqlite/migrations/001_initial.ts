// AUTO-GENERATED from 001_initial.sql — do not edit the SQL inline.
// To regenerate after editing the .sql file, run:
//   node scripts/bake-migrations.js   (see README)
//
// The .sql file is the human-readable source of truth; this .ts file
// exists because Metro does not ship a .sql loader by default and
// wrapping the SQL in a template literal is the simplest path.

export const SQL = `-- Titan Protocol — SQLite initial schema (mirrors Supabase public schema 1:1)
